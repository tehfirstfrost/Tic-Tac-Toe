...
const tabulation ={
    ...
    rotation: function(counter){
        ...
        if(counter%2 === 0){
            turn.innerText = `${p1}'s turn`
        }else if(counter%2 !== 0){
            turn.innerText = `${p2}'s turn`
        }
    },
    play: function(){
...
// function clear(){
//     const p = document.getElementsByClassName('row');
//     for(let i = 0; i < p.length; i++){
//         p[i].innerText = "";
//         p[i].style.cssText = "background-color: antiquewhite;"
//     }
